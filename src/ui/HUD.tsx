...
export function HUD() {
  ...
  return (
    <>
      ...
      <ModifierFlashes />
      <MuteButton />
      {/* aria-live region: screen-readers narrate each new kill bonus
         and score milestone. Visually hidden, deduplicated by content
         (React rerender). polite = doesn't interrupt the player. */}
      <div
        aria-live="polite"
        aria-atomic="true"
        style={{
